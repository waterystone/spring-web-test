...
public class ExcelUtils {
    ...
    public static boolean exportExcel(Map<String, Object> dataElementMap, String templateFilePath, OutputStream outputStream) {
        boolean res = true;
        logger.info("op=exportExcel_start,templateFilePath={}", templateFilePath);
        ...
        try {
            ...
            outputStream.flush();
            logger.info("op=exportExcel_success,templateFilePath={}", templateFilePath);
        } catch (Exception e) {
            logger.error("[ERROR-exportExcel]templateFilePath={},", templateFilePath, e);
            res = false;
        } finally {
            if (inputStream != null) {
                try {
