...
public class HelloController {
	...
	@ResponseBody
	public String showDetail(@PathVariable("userId") int userId, @RequestParam("name") String name,
	...
	@ResponseBody
	public String showCookie(@CookieValue(value = "JSESSIONID") String sessionId,
		...
		return "sessionId=" + sessionId + ",myCookieId=" + myCookieId;
	}
